import isUnicodeIDStartRegex from '@unicode/unicode-13.0.0/Binary_Property/ID_Start/regex.js';
import isUnicodeIDContinueRegex from '@unicode/unicode-13.0.0/Binary_Property/ID_Continue/regex.js';
